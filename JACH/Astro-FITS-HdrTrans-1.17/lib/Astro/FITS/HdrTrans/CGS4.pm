...
#  Revision:
#     $Id: CGS4.pm,v 1.1 2003/07/21 19:59:39 aa Exp $
...
Converts a hash containing CGS4 FITS headers into a hash containing
generic headers.
...
Converts an ISO 8601 formatted date into two FITS headers for CGS4: IDATE
