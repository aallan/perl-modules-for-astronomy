...
#  Revision:
#     $Id: UIST.pm,v 1.1 2003/07/21 19:59:39 aa Exp $
...
Converts information contained in UIST FITS headers to and from
...
Converts a hash containing UIST FITS headers into a hash containing
generic headers.
