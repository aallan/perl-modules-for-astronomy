...
is( $rtml1->group_count(), 2, "<Schedule><Exposure><Count>" );
is( $rtml1->series_count(), 3, "<Schedule><SeriesConstraint><Count>" );
cmp_ok( $rtml1->exposure_time(), '==', 120.0, "<Schedule><Exposure>" );
...
cmp_ok( $rtml2->exposure_time(), '==', 63.5, "<Schedule><Exposure>" );
...
cmp_ok( $rtml3->exposure_time(), '==', 63.5, "<Schedule><Exposure>" );
