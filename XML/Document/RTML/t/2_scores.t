...
my $object;
ok ( $object = new XML::Document::RTML( File => 't/rtml2.2/example_score_reply_scores.rtml' ),
     "Created the object okay" );

# <RTML type="?">
my $role = $object->role( );
is( $role, "score", "Comparing type of document via tha role() method" );
my $type = $object->type( );
is( $type, "score", "Comparing type of document via tha type() method" );
