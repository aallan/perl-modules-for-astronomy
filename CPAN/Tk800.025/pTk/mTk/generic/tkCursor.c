 ...
 *
 * RCS: @(#) $Id: tkCursor.c,v 1.1 2003/09/28 14:54:57 aa Exp $
 */
				 ...
				 * for details on legal syntax. */
{
    ...
    nameKey.name = Tk_GetUid(LangString(arg));
    ...
    cursorPtr = TkGetCursorByName(interp, tkwin, arg);
