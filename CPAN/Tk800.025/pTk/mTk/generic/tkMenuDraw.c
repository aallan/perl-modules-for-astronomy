 ...
 *
 * RCS: @(#) $Id: tkMenuDraw.c,v 1.1 2003/09/28 14:54:57 aa Exp $
 */
...
{             
	...
	result = LangMethodCall(interp, menuPtr->postedCascade->name,  
				"unpost", 0, 0);
	...
	result = LangMethodCall(interp,  mePtr->name, "post", 
				0, 2," %d %d", x, y);
